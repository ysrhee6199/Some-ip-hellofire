...
public:
    ...
    /**
     * Calls sayHello with Fire&Forget semantics.
     *
     ...
     * will be set.
     */
    virtual void sayHello(std::string _name, CommonAPI::CallStatus &_internalCallStatus);
...
template <typename ... _AttributeExtensions>
void HelloWorldProxy<_AttributeExtensions...>::sayHello(std::string _name, CommonAPI::CallStatus &_internalCallStatus) {
    delegate_->sayHello(_name, _internalCallStatus);
}
